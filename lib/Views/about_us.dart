        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              'Contact Information:\n Phone Number: 01551415772\n Email: petothabt@yahoo.com',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
            ),
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                  'مهمتنا هي تمكين الأعمال والأفراد من تطبيقات الهواتف المحمولة المبتكرة التي تمزج بسلاسة بين الإبداع والوظائف. نهدف إلى دفع حدود الابتكار، وتقديم حلول لا تفوق توقعات عملائنا فقط',
                ),
                Text(
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                  ' بل تتجاوزها',
                ...
                Text(
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                  'هل أنت جاهز لتحويل فكرة تطبيقك إلى واقع؟ تواصل مع فريق ',
                ),
                Text(
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
